...
\newacronym{nasa_tlx}{NASA TLX}{NASA Task Load Index}
\newacronym{eeg}{EEG}{Electroencephalogram}
\newacronym{mlp}{MLP}{Multi-Layer Perceptron}
\newacronym{fcn}{FCN}{Fully Convolutional Network}
\newacronym{mcdcnn}{MCDCNN}{Multi-Channel Deep Convolutional Neural Network}
\newacronym{resnet11}{ResNet11}{11-Layer Residual Network}
\newacronym{resnet18}{ResNet18}{18-Layer Residual Network}
\newacronym{relu}{ReLU}{Rectified Linear Unit}
\newacronym{tsc}{TSC}{Time Series Classification}
\newacronym{dnn}{DNN}{Deep Neural Network}
\newacronym{fs}{FS}{Full State}
\newacronym{bs}{BS}{Binary State}
\newacronym{fl}{FL}{Full Level}
\newacronym{bl}{BL}{Binary Level}
\newacronym{esports}{esports}{Electronic Sports}
